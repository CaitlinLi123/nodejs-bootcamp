...
const createSendToken = (user, statusCode, req, res) => {
  ...
  //the second thing is targetting at heroku
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  user.passwordResetToken = undefined;
  user.passwordResetExpires = undefined;
  //we don't use update but use save because we want to run the validator
  await user.save(); //in this case we need the validator to check whether the password is equal to passwordConfirm

  //3). update changePasswordAt property for the user(defined as an instance method)
